...
<div class="line instrumental">
    ...
    <li class="dropdown-item"><input type="color" @input="cssRootAdd()" v-model="hoverCLR"/> Цвет активации кнопок</li>
    <li class="dropdown-item"><input type="color" @input="cssRootAdd()" v-model="letterBorder"/> Цвет обводки при активации</li>
    <li class="dropdown-item"><input type="color" @input="cssRootAdd()" v-model="textClr"/> Цвет текста</li>
    </ul>
  </div>

</div>
   <div class="line" id="line1">
     <span class="letter border rounded-circle btnFix" @click="addToIntput()" ref="ruButtons1" :id="ruButtons1" v-for="ruButtons1 in QWERTYru1" :key="ruButtons1.QWERTYru1">
       {{ruButtons1}}
       </span>
       </div>
       <br>
   <div class="line" id="line2">
     <span  class=" letter border rounded-circle btnFix" @click="addToIntput()"  :id="ruButtons2" v-for="ruButtons2 in QWERTYru2" :key="ruButtons2.QWERTYru2">
      {{ruButtons2}}
       </span>
       </div>
       <br>
   <div class="line" id="line3">
    ...
    <span class=" letter border rounded-circle btnFix" @click="addToIntput()"  :id="ruButtons3" v-for="ruButtons3 in QWERTYru3" :key="ruButtons3.QWERTYru3">
      {{ruButtons3}}
       </span>
       </div>
 ...
 <div class="qwerty" v-if="lang=='EN'" >
   <div class="line" id="line1">
     <span  class=" letter border rounded-circle btnFix" @click="addToIntput()" :id="enButtons1" v-for="enButtons1 in QWERTYen1" :key="enButtons1.QWERTYen1">
       {{enButtons1}}
       </span>
       </div>
       <br>
   <div class="line" id="line2">
     <span class=" letter border rounded-circle btnFix" @click="addToIntput()" :id="enButtons2" v-for="enButtons2 in QWERTYen2" :key="enButtons2.QWERTYen2">
       {{enButtons2}}
       </span>
       </div>
       <br>
   <div class="line" id="line3">
        <i @click="switchLang()" class="bi bi-globe langBTN"></i>
     <span  class=" letter border rounded-circle btnFix" @click="addToIntput()" :id="enButtons3" v-for="enButtons3 in QWERTYen3" :key="enButtons3.QWERTYen3">
       {{enButtons3}}
       </span>
       </div>
       <div class="spaceBtn flex letter border rounded-2" @click="addToIntput()" id=" "></div>
...
export default {
    ...
    methods:{
      ...
      console.log(beforeStyle)
            ...
            document.getElementById(currentBTN.toLowerCase()).style.cssText='background-color:var(--letterHov)!important;top: 1px; left: 1px;position: relative;border:3px solid var(--letterBorder)!important;'
      setTimeout(() => {
